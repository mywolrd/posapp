...
create table if not exists pos.order_detail_addon_items (
	id				serial	primary key,
...
grant select, insert, delete, update on pos.order_detail_addon_items to pos;
grant select, usage on sequence pos.order_detail_addon_items_id_seq to pos;
